export async function POST(request: Request) {
  try {
    ...
    console.log(`📰 Calling centralized news sentiment function for ${symbol}...`)
    ...
    const response = await fetch(`${supabaseUrl}/functions/v1/yahoo-news-sentiment`, {
      method: 'POST',
      headers: {
    ...
    console.log(`✅ News data received for ${symbol}, sentiment: ${newsData.sentiment?.overall}`)
