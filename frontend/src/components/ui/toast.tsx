...
const ToastClose = React.forwardRef<React.ElementRef<typeof ToastPrimitives.CloseButton>, React.ComponentPropsWithoutRef<typeof ToastPrimitives.CloseButton>>(({ className, ...props }, ref) => (
