...
serve(async (req: Request) => {
  ...
  try {
    ...
    // Current price
    const currentPrice =
      closes[closes.length - 1] || meta?.regularMarketPrice || 0;
    ...
    console.log(
      `Created overview for ${symbol} - P/E: ${overview.PERatio}, Current Price: ${currentPrice}`,
    );
    ...
    console.log(
      `✅ Successfully created stock data for ${symbol}, price: ${currentPrice}`,
    );
