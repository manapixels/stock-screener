...
function AuthPrompt() {
  return (
    <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 text-center">
      ...
      <h3 className="text-lg font-medium text-gray-900 mb-2">Sign in to view your alerts</h3>
      <p className="text-gray-600 mb-4">Get notified when your stocks hit target prices</p>
      <Button 
    ...
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      {loading ? (
        ...
        <p className="text-gray-600 text-center py-8">
          No alerts set yet. Create an alert to get notified about price changes!
        </p>
      ) : (
