...
import { getTelegramSettings, saveTelegramSettings, isAuthError } from '@/lib/api';
...
function AuthPrompt() {
  return (
    <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 text-center">
      ...
      <h3 className="text-lg font-medium text-gray-900 mb-2">Sign in to configure Telegram</h3>
      <p className="text-gray-600 mb-4">Connect your Telegram account to receive alert notifications</p>
      <Button 
