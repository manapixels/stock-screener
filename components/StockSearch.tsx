  ...
  return (
    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-blue-800 font-medium">Sign in to save stocks to your watchlist</p>
          <p className="text-blue-600 text-sm">You can still search for stocks without an account</p>
        </div>
        <Button 
