    ...
    <div className="bg-white p-6 rounded-lg shadow-sm border">
        ...
        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
          ...
          <div className="text-right">
            ...
            <div className="flex items-center gap-1">
              ...
              <p className={`text-sm font-medium ${valConfig.color}`}>
                {valConfig.label}
              </p>
            </div>
          </div>
          ...
          <ResponsiveContainer width="100%" height={350}>
            <LineChart data={chartData}>
              ...
              <ReferenceLine
                ...
                strokeWidth={3}
                label={{
                  value: `Current: ${formatCurrencyByContext(currentPrice, currencyCode, "price")}`,
          ...
          <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
            <div className="text-center">
              ...
              <p className="text-xl font-bold text-blue-700">
                {formatCurrencyByContext(targetPrice, currencyCode, "target")}
              </p>
              <p className="text-xs text-blue-600 mt-1">
                {(((targetPrice - currentPrice) / currentPrice) * 100).toFixed(
                  1,
                )}
                % potential return
              </p>
      ...
      <div className="mt-6 p-3 bg-gray-50 rounded-lg">
        <p className="text-sm text-gray-700">
          ...
          {recommendation === "BUY" &&
            ` Consider buying if price reaches ${formatCurrencyByContext(priceTargets.goodBuyPrice, currencyCode, "target")} or below.`}
          {recommendation === "HOLD" &&
            ` Current price is fairly valued. Monitor for entry/exit opportunities.`}
          {recommendation === "SELL" &&
            ` Consider taking profits if price reaches ${formatCurrencyByContext(priceTargets.goodSellPrice, currencyCode, "target")} or above.`}
        </p>
      </div>
    </div>
  );
